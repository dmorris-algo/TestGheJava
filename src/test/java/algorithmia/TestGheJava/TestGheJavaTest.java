package algorithmia.TestGheJava;
...
/**
 * Unit test for TestGheJava algorithm
 */
public class TestGheJavaTest extends TestCase {
    /**
     * Create the test case
     *
     * @param testName name of the test case
     */
    public TestGheJavaTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestGheJavaTest.class);
    }

    /**
     * Basic test
     */
    public void testTestGheJava() throws Exception {
        ...
        TestGheJava algorithm = new TestGheJava();
